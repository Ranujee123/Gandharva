...
<style>
	* {
	...
	.login-card label[for="email"], .login-card label[for="password"] {
		color: black;
	}
...
<body>
	...
	<div class="login-card">
		<h2 class="center-elements" style="color: black">Guest Login</h2>
			<form action="guestLog" method="post">
		...
		<p class="signup-text">
			Don't have an account? <a href="u_reg.jsp">Sign Up</a>
		</p>
	</div>
